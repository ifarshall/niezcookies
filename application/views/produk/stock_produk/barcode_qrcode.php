...
<section class="content">
    ...
    <div class="box">
        <div class="box-header">
            ...
            <div class="pull-right">
                <a href="<?=site_url('produk_stock')?>" class="btn btn-danger btn-flat btn-sm">
        ...
        <div class="box-body">
            ...
            <?=$row->nama?>
            <br><br>
                <a href="<?=site_url('produk_stock/barcode_print/'.$row->produk_id)?>" target="_blank" class="btn btn-default btn-xs">
    ...
    <div class="box">
        ...
        <div class="box-body">
            ...
            <?=$row->nama?>
            <!-- <br><br>
                <a href="<?=site_url('produk_stock/qrcode_print/'.$row->produk_id)?>" target="_blank" class="btn btn-default btn-xs">
                    <i class="fa fa-print"></i> Cetak
                </a> -->
        </div>
    </div>
