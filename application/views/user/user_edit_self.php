...
<section class="content">
    ...
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">Ubah Password / No HP</h3>
            <div class="pull-right">
                <a href="<?=site_url('dashboard')?>" class="btn btn-danger btn-flat">
                ...
                <div class="col-md-4 col-md-offset-4">
                    <form action="" method="post">
                        <div class="form-group <?=form_error('username')? 'has-error':null?>">
                            ...
                            <input type="text" name="username" value="<?=$this->input->post('username') ?? $row->username?>" class="form-control" readonly>
                            <?=form_error('username')?>
                        </div>
                        ...
                        <div class="form-group <?=form_error('fullname')? 'has-error':null?>">    
                            <label>Nama *</label>
                            <input type="text" name="fullname" value="<?=$this->input->post('fullname') ?? $row->nama?>" class="form-control" readonly>
                            <?=form_error('fullname')?>
                        </div>
