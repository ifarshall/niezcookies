                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center" width="160px">
                            ...
                            <a href="<?=site_url('satuan/del/'.$data->satuan_id)?>" id="btn-hapus" class="btn btn-danger btn-xs">
                                <i class="fa fa-trash"></i> Hapus
                            </a>
                            <!-- <a href="#modalDelete" data-toggle="modal" onclick="$('#modalDelete #formDelete').attr('action', '<?=site_url('satuan/del/'.$data->satuan_id)?>')" class="btn btn-danger btn-xs">
                                <i class="fa fa-trash"></i> Hapus
                            </a> -->
                        </td>
                    </tr>
